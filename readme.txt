...
Tags: Contact Form 7, conditional, user-based, dynamic, interactive
Tested up to: 6.6
Stable tag: 2.0.0
...
= 2.0.0 =
Major updates to script function to allow for more flexibiity, including operations, multiple controllers, numeric value checks, more form tags, and a bug fix! See [the changelog](https://plugins.trac.wordpress.org/browser/controller-fields-for-contact-form-7/trunk/changelog.txt) for more details.
